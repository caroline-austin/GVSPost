       ...
       %could probably do this with an eval instead 
        switch check_name
            ...
            case '4A'
                ...
                shot_4A_avg(1) = sum(tilt_actual)/length(tilt_actual);
                shot_4A_avg(shot_col+1) = sum(shot_actual)/length(shot_actual);

                shot_4A(:,shot_col+1) = shot_actual-shot_4A_avg(shot_col+1)+shot_4A_avg(1);
                Label.shot_4A(shot_col+1,:) = string([ current_file(11:end-4), '_shot_actual']);

%                  check_adj = sum(shot_4A(:,shot_col+1))/length(shot_4A(:,shot_col));
            case '4B'
                ...
                shot_4B_avg(1) = sum(tilt_actual)/length(tilt_actual);
                shot_4B_avg(shot_col+1) = sum(shot_actual)/length(shot_actual);

                shot_4B(:,shot_col+1) = shot_actual-shot_4B_avg(shot_col+1)+shot_4B_avg(1);
            ...
            case '5A'
                ...
                shot_5A_avg(1) = sum(tilt_actual)/length(tilt_actual);
                shot_5A_avg(shot_col+1) = sum(shot_actual)/length(shot_actual);

                shot_5A(:,shot_col+1) = shot_actual-shot_5A_avg(shot_col+1)+shot_5A_avg(1);
            ...
            case '5B'
                ...
                shot_5B_avg(1) = sum(tilt_actual)/length(tilt_actual);
                shot_5B_avg(shot_col+1) = sum(shot_actual)/length(shot_actual);

                shot_5B(:,shot_col+1) = shot_actual-shot_5B_avg(shot_col+1)+shot_5B_avg(1);
            ...
            case '6A'
                ...
                shot_6A_avg(1) = sum(tilt_actual)/length(tilt_actual);
                shot_6A_avg(shot_col+1) = sum(shot_actual)/length(shot_actual);

                shot_6A(:,shot_col+1) = shot_actual-shot_6A_avg(shot_col+1)+shot_6A_avg(1);
            ...
            case '6B'
                ...
                shot_6B_avg(1) = sum(tilt_actual)/length(tilt_actual);
                shot_6B_avg(shot_col+1) = sum(shot_actual)/length(shot_actual);

                shot_6B(:,shot_col+1) = shot_actual-shot_6B_avg(shot_col+1)+shot_6B_avg(1);
...
%     pos_colors=['r'; 'r'; 'g'; 'g';'c'; 'c';'b';'b']; % PS1002
    ...
    subplot(3,1,1)
    title('4A Positive GVS Affects on Tilt Perception BiasAdj')

    cd(plots_path);
    saveas(gcf, [ 'Positive_4A_4_00mA_PerceptionBiasAdj' subject_str]); 
    cd(code_path);
    hold off;
    ...
    subplot(3,1,1)
    title('4A Negative GVS Affects on Tilt Perception BiasAdj')

    cd(plots_path);
    saveas(gcf, [ 'Negative_4A_4_00mA_PerceptionBiasAdj' subject_str]); 
    cd(code_path);
    hold off;
...
%% Plot 4B with function
    ...
    subplot(3,1,1)
    title('4B Positive GVS Affects on Tilt Perception BiasAdj')

    cd(plots_path);
    saveas(gcf, [ 'Positive_4B_4_00mA_PerceptionBiasAdj' subject_str]); 
    cd(code_path);
    hold off;
    ...
    subplot(3,1,1)
    title('4B Negative GVS Affects on Tilt Perception BiasAdj')

    cd(plots_path);
    saveas(gcf, [ 'Negative_4B_4_00mA_PerceptionBiasAdj' subject_str]); 
    cd(code_path);
    hold off;
...
%     pos_colors=['r'; 'r'; 'g'; 'g'; 'g'; 'c'; 'c';'b';'b']; %PS1002
    ...
    subplot(3,1,1)
    title('5A Positive GVS Affects on Tilt Perception BiasAdj')

    cd(plots_path);
    saveas(gcf, [ 'Positive_5A_4_00mA_PerceptionBiasAdj' subject_str]); 
    cd(code_path);
    hold off;
%     pos_colors=['r'; 'r'; 'g';  'g';'c'; 'c';'b';'b']; % PS1002
    pos_colors=['r'; 'r'; 'g'; 'c';'b']; % PS1003 and 4
    ...
    subplot(3,1,1)
    title('5A Negative GVS Affects on Tilt Perception BiasAdj')

    cd(plots_path);
    saveas(gcf, [ 'Negative_5A_4_00mA_PerceptionBiasAdj' subject_str]); 
    cd(code_path);
    hold off;
...
%% Plot 5B with function
    ...
    subplot(3,1,1)
    title('5B Positive GVS Affects on Tilt Perception BiasAdj')

    cd(plots_path);
    saveas(gcf, [ 'Positive_5B_4_00mA_PerceptionBiasAdj' subject_str]); 
    cd(code_path);
    hold off;
    ...
    subplot(3,1,1)
    title('5B Negative GVS Affects on Tilt Perception BiasAdj')

    cd(plots_path);
    saveas(gcf, [ 'Negative_5B_4_00mA_PerceptionBiasAdj' subject_str]); 
    cd(code_path);
    hold off;    
...
%     pos_colors=['r'; 'r'; 'g'; 'c'; 'b']; %1003?
    ...
    subplot(3,1,1)
    title('6A Positive GVS Affects on Tilt Perception BiasAdj')

    cd(plots_path);
    saveas(gcf, [ 'Positive_6A_4_00mA_PerceptionBiasAdj' subject_str]); 
    cd(code_path);
    hold off;
    ...
    subplot(3,1,1)
    title('6A Negative GVS Affects on Tilt Perception BiasAdj')

    cd(plots_path);
    saveas(gcf, [ 'Negative_6A_4_00mA_PerceptionBiasAdj' subject_str]); 
    cd(code_path);
    hold off;
...
%% Plot 6B with function
    ...
    subplot(3,1,1)
    title('6B Positive GVS Affects on Tilt Perception BiasAdj')

    cd(plots_path);
    saveas(gcf, [ 'Positive_6B_4_00mA_PerceptionBiasAdj' subject_str]); 
    cd(code_path);
    hold off;
    ...
    subplot(3,1,1)
    title('6B Negative GVS Affects on Tilt Perception BiasAdj')

    cd(plots_path);
    saveas(gcf, [ 'Negative_6B_4_00mA_PerceptionBiasAdj' subject_str]); 
    cd(code_path);
    hold off;    
...
%% save files
   cd(subject_path);
   vars_2_save = ['Label Trial_Info time shot_4A tilt_4A GVS_4A  shot_5A tilt_5A GVS_5A shot_6A tilt_6A GVS_6A shot_4B tilt_4B GVS_4B  shot_5B tilt_5B GVS_5B shot_6B tilt_6B GVS_6B '];
