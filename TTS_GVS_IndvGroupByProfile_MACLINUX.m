%function [] = TTS_GVS_IndvGroupByProfile_MACLINUX(subnum,numsub,subskip)
close all; clear; clc; 

%% set up
subnum = 1015:1015;  % Subject List 
numsub = length(subnum);
subskip = [1013 40005 40006];
...
%     subject_path = [file_path, '/PS' , subject_str];
   ...
   %variables into
   GVS_4A = [];tilt_4A = [];shot_4A = [];
   GVS_4B = [];tilt_4B = [];shot_4B = [];
   GVS_5A = [];tilt_5A = [];shot_5A = [];
   GVS_5B = [];tilt_5B = [];shot_5B = [];
   GVS_6A = [];tilt_6A = [];shot_6A = [];
   GVS_6B = [];tilt_6B = [];shot_6B = [];
