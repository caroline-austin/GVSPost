        ...
        switch check_profile_name
            ...
            case '4A'
                ...
                [GVS_4A, Label] = AddOnData3(GVS_4A,GVS_command, ... 
                    -GVS_actual1_mV,-GVS_actual1_filt, Label, 'GVS_4A', ... 
                    '_GVS_command', '_GVS_actual1_mV', '_GVS_actual1_filt', ... 
                    current_file);
            ...
            case '4B'
               [GVS_4B, Label] = AddOnData3(GVS_4B,GVS_command, ... 
                    -GVS_actual1_mV,-GVS_actual1_filt, Label, 'GVS_4B', ... 
                    '_GVS_command', '_GVS_actual1_mV', '_GVS_actual1_filt', ... 
                    current_file);
            ...
            case '5A'
                ...
                [GVS_5A, Label] = AddOnData3(GVS_5A,GVS_command, ... 
                    -GVS_actual1_mV,-GVS_actual1_filt, Label, 'GVS_5A', ... 
                    '_GVS_command', '_GVS_actual1_mV', '_GVS_actual1_filt', ... 
                    current_file);
            ...
            case '5B'
                ...
                [GVS_5B, Label] = AddOnData3(GVS_5B,GVS_command, ... 
                    -GVS_actual1_mV,-GVS_actual1_filt, Label, 'GVS_5B', ... 
                    '_GVS_command', '_GVS_actual1_mV', '_GVS_actual1_filt', ... 
                    current_file);
            ...
            case '6A'
                ...
                [GVS_6A, Label] = AddOnData3(GVS_6A,GVS_command, ... 
                    -GVS_actual1_mV,-GVS_actual1_filt, Label, 'GVS_6A', ... 
                    '_GVS_command', '_GVS_actual1_mV', '_GVS_actual1_filt', ... 
                    current_file);
            ...
            case '6B'
                ...
                [GVS_6B, Label] = AddOnData3(GVS_6B,GVS_command, ... 
                    -GVS_actual1_mV,-GVS_actual1_filt, Label, 'GVS_6B', ... 
                    '_GVS_command', '_GVS_actual1_mV', '_GVS_actual1_filt', ... 
                    current_file);
