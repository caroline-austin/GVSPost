...
% This script reads in the output of script 1 (X2DGetIMUfiles) and processes
...
for sub = 1:numsub
    ...
    for file = 1:length(IMU_files)
        ...
        IMUTrialInfo(trial,:)= (data_info);

    end
    Label.DataColumns = info_label;
