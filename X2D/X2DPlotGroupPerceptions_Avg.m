function X2DPlotGroupPerceptions_Avg(Type,Var)
...
for j = 1:3
    ...
    for i = 1:3
        for k = 1:2
            ...
            elseif k == 2
                percplot = (percplot + -1*interp1(time,perceptions,timeplot))/2;
                semplot = (interp1(time,percSEM,timeplot).^2+semplot.^2).^(1/2);
            end
        end
