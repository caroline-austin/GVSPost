...
%     subject_path = [file_path, '\PS' , subject_str];
    ...
    cd(subject_path);
    load(['PS', subject_str, 'GroupAdj.mat ']);
...
%     pos_colors=['r'; 'r'; 'g'; 'g';'c'; 'c';'b';'b']; % PS1002
    pos_colors=Color_List;%['r'; 'r'; 'g'; 'c';'b']; % PS1003 and 4
    PlotGVSTTSPerception(Label.shot_4A,Label.GVS_4A, ...
        tilt_4A(1:trial_end,:),shot_4A(1:trial_end,:),GVS_4A(1:trial_end,:), ...
        time(1:trial_end),pos_colors,pos_prof,match_list);
    subplot(3,1,1)
    title('4A Positive GVS Affects on Tilt PerceptionAdj')

    cd(plots_path);
    saveas(gcf, [ 'Positive_4A_4_00mA_PerceptionAdj' subject_str]); 
    cd(code_path);
    hold off;
    ...
    PlotGVSTTSPerception(Label.shot_4A,Label.GVS_4A, ...
        tilt_4A(1:trial_end,:),shot_4A(1:trial_end,:),GVS_4A(1:trial_end,:), ...
        time(1:trial_end),pos_colors,neg_prof,match_list);
    subplot(3,1,1)
    title('4A Negative GVS Affects on Tilt PerceptionAdj')

    cd(plots_path);
    saveas(gcf, [ 'Negative_4A_4_00mA_PerceptionAdj' subject_str]); 
    cd(code_path);
    hold off;
...
%     pos_colors=[ 'r'; 'g'; 'c';'b']; % PS1003 and 4
    PlotGVSTTSPerception(Label.shot_4B,Label.GVS_4B, ...
        ...
        time(1:trial_end),pos_colors,pos_prof, match_list);
    subplot(3,1,1)
    title('4B Positive GVS Affects on Tilt PerceptionAdj')

    cd(plots_path);
    saveas(gcf, [ 'Positive_4B_4_00mA_PerceptionAdj' subject_str]); 
    cd(code_path);
    hold off;
    ...
    PlotGVSTTSPerception(Label.shot_4B,Label.GVS_4B, ...
        ...
        time(1:trial_end),pos_colors,neg_prof,match_list);
    subplot(3,1,1)
    title('4B Negative GVS Affects on Tilt PerceptionAdj')

    cd(plots_path);
    saveas(gcf, [ 'Negative_4B_4_00mA_PerceptionAdj' subject_str]); 
    cd(code_path);
    hold off;
...
%     pos_colors=['r'; 'r'; 'g'; 'c';'b']; % PS1003 and 4
    PlotGVSTTSPerception(Label.shot_5A,Label.GVS_5A, ...
        ...
        time(1:trial_end),pos_colors,pos_prof,match_list);
    subplot(3,1,1)
    title('5A Positive GVS Affects on Tilt PerceptionAdj')

    cd(plots_path);
    saveas(gcf, [ 'Positive_5A_4_00mA_PerceptionAdj' subject_str]); 
    cd(code_path);
    hold off;
%     pos_colors=['r'; 'r'; 'g';  'g';'c'; 'c';'b';'b']; % PS1002
%     pos_colors=['r'; 'r'; 'g'; 'c';'b']; % PS1003 and 4
    ...
    PlotGVSTTSPerception(Label.shot_5A,Label.GVS_5A, ...
        ...
        time(1:trial_end),pos_colors,neg_prof,match_list);
    subplot(3,1,1)
    title('5A Negative GVS Affects on Tilt PerceptionAdj')

    cd(plots_path);
    saveas(gcf, [ 'Negative_5A_4_00mA_PerceptionAdj' subject_str]); 
    cd(code_path);
    hold off;
...
%     pos_colors=[ 'r'; 'g'; 'c';'b']; % PS1003 and 4
    PlotGVSTTSPerception(Label.shot_5B,Label.GVS_5B, ...
        ...
        time(1:trial_end),pos_colors,pos_prof, match_list);
    subplot(3,1,1)
    title('5B Positive GVS Affects on Tilt PerceptionAdj')

    cd(plots_path);
    saveas(gcf, [ 'Positive_5B_4_00mA_PerceptionAdj' subject_str]); 
    cd(code_path);
    hold off;
    ...
    PlotGVSTTSPerception(Label.shot_5B,Label.GVS_5B, ...
        ...
        time(1:trial_end),pos_colors,neg_prof,match_list);
    subplot(3,1,1)
    title('5B Negative GVS Affects on Tilt PerceptionAdj')

    cd(plots_path);
    saveas(gcf, [ 'Negative_5B_4_00mA_PerceptionAdj' subject_str]); 
    cd(code_path);
    hold off;    
...
%     pos_colors=['r'; 'r'; 'g'; 'c';'b']; % PS1003 and 4
    PlotGVSTTSPerception(Label.shot_6A,Label.GVS_6A, ...
        ...
        time(1:trial_end),pos_colors,pos_prof,match_list);
    subplot(3,1,1)
    title('6A Positive GVS Affects on Tilt PerceptionAdj')

    cd(plots_path);
    saveas(gcf, [ 'Positive_6A_4_00mA_PerceptionAdj' subject_str]); 
    cd(code_path);
    hold off;
    ...
    PlotGVSTTSPerception(Label.shot_6A,Label.GVS_6A, ...
        ...
        time(1:trial_end),pos_colors,neg_prof,match_list);
    subplot(3,1,1)
    title('6A Negative GVS Affects on Tilt PerceptionAdj')

    cd(plots_path);
    saveas(gcf, [ 'Negative_6A_4_00mA_PerceptionAdj' subject_str]); 
    cd(code_path);
    hold off;
...
%     pos_colors=['r'; 'g'; 'c';'b']; % PS1003 and 4
    PlotGVSTTSPerception(Label.shot_6B,Label.GVS_6B, ...
        ...
        time(1:trial_end),pos_colors,pos_prof,match_list);
    subplot(3,1,1)
    title('6B Positive GVS Affects on Tilt PerceptionAdj')

    cd(plots_path);
    saveas(gcf, [ 'Positive_6B_4_00mA_PerceptionAdj' subject_str]); 
    cd(code_path);
    hold off;
    ...
    PlotGVSTTSPerception(Label.shot_6B,Label.GVS_6B, ...
        ...
        time(1:trial_end),pos_colors,neg_prof,match_list);
    subplot(3,1,1)
    title('6B Negative GVS Affects on Tilt PerceptionAdj')

    cd(plots_path);
    saveas(gcf, [ 'Negative_6B_4_00mA_PerceptionAdj' subject_str]); 
    cd(code_path);
    hold off;    
