...
file_path = '/home/gvslinux/Documents/ChairGVS/Profiles/Cevette';
...
Electrode_Num=input('4) Enter number of electrodes using (2-5): ');
...
if Profile_Type==1
    [GVS_Signal]=TTS_Sinusoidal(t,fs,PmA,Polarity_Type);
