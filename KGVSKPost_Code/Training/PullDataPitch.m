function [model_time, motiondata, perceptions, current] = ...
    ...
    elseif condition == 4 % postive means amplifying according to F&D04 (not positive couple)
    ...
    elseif condition == 2 % This one is optimal attenuating according to modified roll model
        ...
        current(current<-5) = -5;
        current(current>5) = 5;
    elseif condition == 5 % This one is optimal amplifying according to modified roll model
