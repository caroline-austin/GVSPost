...
file_path = '/home/gvslinux/Documents/ChairGVS/Profiles/MontageTesting/Aoyama_Sin0_50Hz';
...
% information
% Filename = 'Aoyama_4_00mA_10s_sin0_50Hz_bipolar_50Hz'; % the name you would like to file to be saved as 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% automate based on a specific variable
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
var_min = 0.5;
var_max = 3.5;
var_delta = 1;

for var = var_min: var_delta :var_max
    PmA=var; 
    PmA_txt = num2str(PmA,'%.2f');
    PmA_txt = strrep(PmA_txt, '.', '_');
    Filename = ['Aoyama_' PmA_txt 'mA_10s_sin0_50Hz_nopolar_50Hz'];
